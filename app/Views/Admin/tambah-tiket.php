...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="tambah_tiket">
          ...
          <div class="row">
            <div class="card">
              <div class="card-body">
                ...
                <!-- Horizontal Form -->
                <form action="proses_tambah_tiket" method="post">
                  <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    <label for="harga_tiket" class="col-sm-2 col-form-label">Harga Tiket Reguler</label>
                    <div class="col-sm-10">
                  ...
                  <!-- <div class="row mb-3">
                    <label for="harga_tiket2" class="col-sm-2 col-form-label">Harga Tiket VIP</label>
                    <div class="col-sm-10">
                      <input type="number" class="form-control" id="harga_tiket2" name="harga_tiket2">
                    </div>
                  </div> -->
