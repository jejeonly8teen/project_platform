...
<body>
    ...
    <section class="highlight-blue" style="background: url(&quot; <?php echo base_url("Tiket/img/sleman.jpg"); ?>  &quot;) top / cover repeat;padding: 200px 0px;">
        <h1 class="text-center " style="font-size: 45.88px;">Pemesanan Berhasil</h1>
        <div class="container">
            <div class="intro">
                <p class="text-center">ISI PEMESANAN ---&gt; KONFIRMASI</p>
            </div>
            <div class="buttons"></div>
        </div>
    </section>
    <section class="contact-clean" style="background: #003825;padding-bottom: 156px;">
        <h1 class="text-white">Sukses Memesan</h1>
    
        <a class="btn btn-primary" href="/halaman_customer">Kembali</a>
    </section>
