...
<body>
    ...
    <section class="highlight-blue" style="background: url(&quot;<?php echo base_url("Tiket/img/sleman.jpg"); ?>&quot;) top / cover repeat;padding: 200px 0px;">
        <h1 class="text-center" style="font-size: 45.88px;">JADWAL PERTANDINGAN</h1>
        <div class="container">
            <div class="intro">
                <p class="text-center">HOME ---&gt; JADWAL PERTANDINGAN</p>
            </div>
    ...
    <section class="features-boxed">
        <div class="container">
            <div class="intro">
                <h2 class="text-center">LIHAT PERTANDINGAN YANG ADA</h2>
            </div>
            <div>
                    ...
                    <table class="table table-striped table-borderless">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($event as $row) : ?>
                                <tr>
                                    <td> <img src="<?php echo base_url("assets/img/" . $row['gambar']); ?>" alt="" style="width: 100px;"> </td>
